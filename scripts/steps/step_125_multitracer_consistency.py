...
STEP_NUM  = "125"  # Pipeline step number (sequential 001-176)
STEP_NAME = "multitracer_consistency"  # Multi-tracer redshift consistency: Spearman rho(Gamma_t, dust) across UNCOVER/CEERS/COSMOS-Web/JADES surveys testing systematic uniformity
...
import numpy as np
from scipy.stats import spearmanr  # Rank correlation for consistency check (non-parametric, robust to outliers)

INTERIM = PROJECT_ROOT / "data" / "interim"  # Processed catalogue products
OUTPUTS = PROJECT_ROOT / "results" / "outputs"  # JSON output directory
