...
STEP_NUM = "073"  # Pipeline step number (sequential 001-176)
STEP_NAME = "growth_factor"  # Growth factor: solves linear structure formation ODE for D(z) and σ₈(z) in TEP scalar-tensor framework (G_eff = G_N × (1 + 2β²) in unscreened regime)
...
def run_growth_calculation():
    ...
    with open(OUTPUT_PATH / "step_073_growth_factor.json", "w") as f:
