...
STEP_NUM = "111"  # Pipeline step number (sequential 001-176)
STEP_NAME = "power_analysis"  # Statistical power analysis: Fisher z-transformation for correlation detection power, minimum detectable rho, required sample sizes for 80% power
