#!/usr/bin/env python3
"""
TEP-JWST Step 63: Correlation Deep Dive
...
5. THE FUNCTIONAL FORM DISCRIMINATION COMPARISON: t_eff vs t_cosmic (the critical signal)
"""
...
STEP_NUM = "063"  # Pipeline step number (sequential 001-176)
STEP_NAME = "correlation_deep_dive"  # Correlation deep dive: compares Spearman vs Pearson vs Kendall, tests nonlinear relationships, threshold effects, interaction effects, and t_eff vs t_cosmic discrimination
...
def main():
    ...
    # ==========================================================================
    # TEST 2: The Functional Form Discrimination Comparison (t_eff vs t_cosmic)
    # ==========================================================================
    print_status("\n" + "=" * 70, "INFO")
    print_status("TEST 2: The Functional Form Discrimination Comparison (t_eff vs t_cosmic)", "INFO")
    print_status("=" * 70, "INFO")
    print_status("This is the CRITICAL SIGNAL evidence for TEP.\n", "INFO")
    ...
    print_status("\n┌─────────────────────────────────────────────────────────────────┐", "INFO")
    print_status("│                    THE CRITICAL SIGNAL EVIDENCE                     │", "INFO")
    print_status("├─────────────────────────────────────────────────────────────────┤", "INFO")
    print_status("│                                                                 │", "INFO")
