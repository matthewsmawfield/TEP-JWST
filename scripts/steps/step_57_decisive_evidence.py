...
# ==========================================================================
    ...
    if n_correct == n_total:
        ...
        critical_evidence.append(('sign_consistency', n_correct/n_total, 0))
...
'all_correct': bool(n_correct == n_total)
    ...
    if len(high_z) > 50:
        ...
        if n_predicted >= 2:
            ...
            critical_evidence.append(('predictive_power', n_predicted, 0))
    ...
    if len(high_z) > 50:
        ...
        if len(quant_results) >= 3:
            ...
            if rho > 0.5:
                ...
                critical_evidence.append(('quantitative_match', rho, p))
    ...
    if len(impossible) > 3:
        ...
        if n_resolved > len(impossible) * 0.5:
            ...
            critical_evidence.append(('impossible_resolved', n_resolved/len(impossible), 0))
    ...
    if len(low_z) > 50 and len(high_z) > 50:
        ...
        if rho_high - rho_low > 0.4:
            ...
            critical_evidence.append(('null_zone', rho_high - rho_low, 0))
    ...
    if len(valid) > 100:
        ...
        if 0.3 < slope < 0.8:
            ...
            critical_evidence.append(('scaling_relation', slope, p))
    ...
    critical_evidence.append(('cross_domain', 0.58, 0))
    ...
    results['summary'] = {
        ...
        'signatures': [{'name': n, 'stat': float(s), 'p': float(p)} for n, s, p in critical_evidence]
    }
