...
STEP_NAME = "screening_transition_profile"  # Screening transition profile: chameleon-type logistic suppression factor (0=fully screened, 1=unscreened) as function of rho/rho_c
...
from scripts.utils.tep_model import ALPHA_0, RHO_CRIT_G_CM3  # TEP model: alpha_0=0.58, screening density rho_c=20 g/cm³
...
FIGURES_DIR = Path(__file__).parent.parent.parent / "results" / "figures"  # Publication figures directory (PNG/PDF for manuscript)
