...
def main():
    ...
    # ==========================================================================
    # TEST 7: The "Impossible" Test
    # ==========================================================================
    print_status("\n" + "=" * 70, "INFO")
    print_status("TEST 7: The 'Impossible' Test", "INFO")
    print_status("=" * 70, "INFO")
    ...
    if len(high_z) > 50:
        # Define "impossible" as high Gamma_t but low dust
        ...
        if len(high_gamma) > 5:
            ...
            if len(low_dust_high_gamma) / len(high_gamma) < 0.1:
                print_status("\n✓ Very few 'impossible' cases → TEP predictions hold", "INFO")
