...
STEP_NUM  = "131"  # Pipeline step number
STEP_NAME = "agn_power"  # Used in log / output filenames
...
import numpy as np
from scipy.stats import spearmanr  # Rank correlation for AGN contamination model
