...
STEP_NUM = "083"  # Pipeline step number (sequential 001-176)
STEP_NAME = "falsification_battery"  # Falsification battery: 6 comprehensive tests (sign consistency, magnitude scaling, redshift evolution, mass independence, null regions, cross-survey consistency)
