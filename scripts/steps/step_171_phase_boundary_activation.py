#!/usr/bin/env python3
"""
Step 171: AGB Dust Phase Boundary + Activation Curve + Spectroscopic Sharpening
...
Outputs:
- results/outputs/step_171_phase_boundary_activation.json
...
def make_figure(test1_result, test1_df, z_boundary, mstar_boundary,
    ...
    plt.suptitle("Step 171: AGB Phase Boundary, Activation Curve & Spec-z Sharpening",
...
def main():
    logger.info("=" * 70)
    logger.info("Step 171: Phase Boundary + Activation Curve + Spec-z Sharpening")
    logger.info("=" * 70)
    ...
    results = {
        "step": "Step 171: AGB Phase Boundary + Activation Curve + Spec-z Sharpening",
    }
