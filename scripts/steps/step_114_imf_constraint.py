...
STEP_NUM = "114"  # Pipeline step number (sequential 001-176)
STEP_NAME = "imf_constraint"  # IMF constraint: derives that IMF must be closer to Chabrier/Kroupa than top-heavy if TEP explains mass anomaly (Gamma_t_typical=2.0 for z>8 massive galaxies)
...
GAMMA_T_TYPICAL = 2.0  # Representative Γ_t enhancement for massive z>8 galaxies
