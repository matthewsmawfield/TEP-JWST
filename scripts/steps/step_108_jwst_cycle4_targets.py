...
STEP_NUM = "108"  # Pipeline step number (sequential 001-176)
STEP_NAME = "jwst_cycle4_targets"  # JWST Cycle 4 targets: prioritized observing proposal list ranked by discriminating power (Gamma_t × sqrt(1+z) / (1+z)^1.5)
...
def main():
    ...
    data_path_v1 = INTERIM_DIR / "step_002_uncover_full_sample_tep.csv"
