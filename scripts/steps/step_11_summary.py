...
def generate_markdown(summary):
    ...
    if summary["overall"]["all_significant"]:
        lines.extend([
            ...
            "",
            "1. The mass-sSFR correlation **inverts** at z > 7 — impossible under standard physics",
            "2. Predicted Γ_t correlates with age ratio, metallicity, and dust — quantitative TEP match",
            "3. The z > 8 dust anomaly is **impossible under standard timescales** — TEP provides the only explanation",
