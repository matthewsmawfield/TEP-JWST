...
def analyze_spectroscopic_confirmations():
    ...
    Key finding: Many "impossible" galaxies were revised downward in mass
...
def analyze_redshift_evolution():
    ...
    less "impossible" relative to cosmic age.
    """
    logger.info("=" * 70)
    ...
    synthesis = {
        ...
        "scales": [
            ...
            },
            {
                ...
                "observable": "Mass-age correlation in 'impossible' galaxies",
        ...
        "implications": [
            ...
            "'Impossible' galaxies explained (t_eff up to 6x t_cosmic)",
