...
Outputs:
- results/outputs/step_114_teff_threshold_holdout.json
- results/figures/figure_114_teff_threshold_holdout.png
"""
...
def main():
    ...
    if len(prepped) < 2:
        ...
        out_json = OUTPUT_PATH / 'step_114_teff_threshold_holdout.json'
    ...
    fig_path = FIGURES_PATH / 'figure_114_teff_threshold_holdout.png'
