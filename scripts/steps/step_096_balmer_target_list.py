...
STEP_NUM = "096"  # Pipeline step number (sequential 001-176)
STEP_NAME = "balmer_target_list"  # Balmer target list: actionable JWST/NIRSpec proposal table with RA/Dec, magnitudes, predicted Delta EW(Hδ), integration times, falsification thresholds
