...
Outputs:
- results/outputs/step_079_ml_cross_validation.json
"""
...
STEP_NUM = "079"  # Pipeline step number (sequential 001-176)
STEP_NAME = "ml_cross_validation"  # M/L scaling cross-validation: K-fold, redshift-blind (z<6 vs z>6), and survey-blind (UNCOVER vs CEERS/COSMOS-Web) validation of M/L ~ t^n exponent
