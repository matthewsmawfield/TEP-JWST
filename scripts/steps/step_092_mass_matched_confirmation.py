...
STEP_NUM = "092"  # Pipeline step number (sequential 001-176)
STEP_NAME = "mass_matched_confirmation"  # Mass-matched stratified confirmation: reduces confounding via mass-stratified Spearman, mass+z matched comparison, partial-residual correlations
