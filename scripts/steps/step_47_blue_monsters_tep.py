#!/usr/bin/env python3
"""
TEP-JWST Step 47: Blue Monsters TEP Analysis
...
Outputs:
- results/outputs/step_47_blue_monsters_tep.json
- results/outputs/step_47_blue_monsters_tep.csv
...
def load_uncover_data():
    ...
    if not uncover_path.exists():
        ...
        uncover_path = PROJECT_ROOT / "results" / "interim" / "step_01_uncover_z8_sample.csv"
...
def run_analysis():
    ...
    literature_data = [
        ...
        # Labbe et al. 2023 "impossible" galaxies (subset with high SFE)
    ...
    json_path = OUTPUT_PATH / f"step_{STEP_NUM}_blue_monsters_tep.json"
