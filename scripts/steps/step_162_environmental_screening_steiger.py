#!/usr/bin/env python3
"""
Step 162: Environmental Screening Steiger Z-Test
...
Outputs:
- results/outputs/step_162_environmental_screening_steiger.json
"""
...
def load_uncover():
    ...
    if not uncover_path.exists():
        uncover_path = INTERIM_PATH / "step_01_uncover_full_sample.csv"
    if not uncover_path.exists():
...
def main():
    logger.info("=" * 70)
    logger.info("Step 162: Environmental Screening Steiger Z-Test")
    logger.info("=" * 70)
    ...
    results = {
        "step": "Step 162: Environmental Screening Steiger Z-Test",
        "tep_prediction": (
