...
from scripts.utils.tep_model import ALPHA_0, compute_gamma_t as tep_gamma, stellar_to_halo_mass_behroozi_like  # TEP model: alpha_0=0.58, Gamma_t formula, stellar-to-halo mass from abundance matching
