...
STEP_NUM = "089"  # Pipeline step number (sequential 001-176)
STEP_NAME = "teff_threshold_scan"  # t_eff threshold scan: AGB-timescale discovery testing dust-detection odds ratio above/below t_eff thresholds (~300 Myr AGB production time)
