...
STEP_NUM = "110"  # Pipeline step number (sequential 001-176)
STEP_NAME = "gw_timing_prediction"  # Gravitational wave timing prediction: EMRI timing residuals (LISA), binary pulsar period derivatives, compact binary merger rate enhancement (Gamma_t near SMBHs)
