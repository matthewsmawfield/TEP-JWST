...
6. Impossible galaxies (age_ratio > 0.5)
...
def test_impossible_galaxies(df_full):
    ...
    print("\n" + "=" * 50)
    print("TEST 3: IMPOSSIBLE GALAXIES")
    print("=" * 50)
    ...
    return {"test": "Impossible Galaxies", "n_impossible": int(n_impossible)}
...
def main():
    ...
    results["impossible"] = test_impossible_galaxies(df_full)
    ...
    print(f"  3. Impossible galaxies have higher Γ_t (p < 10⁻⁵)")
