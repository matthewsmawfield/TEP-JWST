...
def estimate_cosmic_variance(area_arcmin2, z_min, z_max, n_galaxies):
    ...
    """
    # Convert area to comoving volume (approximate)
    # At z ~ 8, 1 arcmin ~ 0.5 Mpc (comoving)
    area_mpc2 = area_arcmin2 * (0.5)**2  # Very rough
    
    # Depth in Mpc (comoving) for z_min to z_max
    # At z ~ 8, dz = 1 corresponds to ~200 Mpc
