...
STEP_NUM = "87"
STEP_NAME = "compactness_verification"
...
PATHS = {
    ...
    "output_json": PROJECT_ROOT / "results" / "outputs" / "step_87_compactness_verification.json"
}
...
def run():
    ...
    if len(valid_ks) > 0:
        ...
        # Fallback to absolute median to get scale, or just median of all finite
