#!/usr/bin/env python3
"""
Step 110: t_eff Threshold Scan (AGB-timescale discovery)
...
Outputs:
- results/outputs/step_110_teff_threshold_scan.json
- results/figures/figure_110_teff_threshold_scan.png
"""
...
def main():
    ...
    if combined_rows:
        ...
        fig_path = FIGURES_PATH / 'figure_110_teff_threshold_scan.png'
    ...
    out_json = OUTPUT_PATH / 'step_110_teff_threshold_scan.json'
