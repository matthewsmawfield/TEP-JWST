#!/usr/bin/env python3
"""
TEP-JWST Step 41: Overmassive Black Hole Simulation
...
Outputs:
- results/outputs/step_41_overmassive_bh.json
- results/outputs/step_41_bh_growth_table.csv
"""
