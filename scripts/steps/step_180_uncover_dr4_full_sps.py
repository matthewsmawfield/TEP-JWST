#!/usr/bin/env python3
"""
TEP-JWST Step 180: UNCOVER DR4 Full SPS Catalog (MegaScience-updated)
...
Outputs:
- results/interim/step_180_uncover_dr4_full_sps.csv
- results/interim/step_180_uncover_dr4_zspec.csv
- results/outputs/step_180_uncover_dr4_full_sps.json
...
def load_full_sps():
    ...
    path = DATA_PATH / "UNCOVER_DR4_SPS_catalog.fits"
...
def load_zspec_sps():
    ...
    path = DATA_PATH / "UNCOVER_DR4_SPS_zspec_catalog.fits"
...
def main():
    ...
    print_status("STEP 180: UNCOVER DR4 Full SPS Catalog (MegaScience)", "INFO")
    print_status("=" * 60, "INFO")
    ...
    out_csv = INTERIM_PATH / "step_180_uncover_dr4_full_sps.csv"
    ...
    out_csv_z = INTERIM_PATH / "step_180_uncover_dr4_zspec.csv"
