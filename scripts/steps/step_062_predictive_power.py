...
STEP_NUM = "062"  # Pipeline step number (sequential 001-176)
STEP_NAME = "predictive_power"  # Predictive power: evaluates TEP predictive capability via OLS regression, Random Forest, cross-validation, and feature importance (R² metrics)
