...
"""
TEP-JWST Step 41: Forward-Modeling SED Validation
...
4. Evaluates alternative models (bursty SFH, metallicity variations)
...
Outputs:
- results/outputs/step_041_forward_modeling.json
- results/outputs/step_041_forward_modeling.csv
"""
...
from scipy.optimize import minimize_scalar  # 1-D optimisation for best-fit n_ML
...
STEP_NUM = "041"  # Pipeline step number (sequential 001-176)
STEP_NAME = "forward_modeling"  # Forward-modeling SED validation: tests TEP mass corrections via synthetic SED generation (FSPS-like)
...
def main():
    ...
    # ==========================================================================
    # Test 2: alternative models (Bursty SFH, Metallicity)
    # ==========================================================================
    print_status("\n--- Test 2: alternative models ---", "INFO")
    ...
    if alt_results is not None:
        ...
        print_status("  Insufficient data for Alternative Model test", "WARNING")
    ...
    print_status(f"  alternative models rejected: {summary['alternative_hypotheses_rejected']}", "INFO")
