...
"""
TEP-JWST Step 44: Metallicity-Age Decoupling Test
...
STEP_NUM = "044"  # Pipeline step number (sequential 001-176)
STEP_NAME = "metallicity_age_decoupling"  # Metallicity-age decoupling: tests TEP prediction that high-Gamma_t galaxies appear old but not metal-rich (discriminating indicator)
