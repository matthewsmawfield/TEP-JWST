...
STEP_NUM  = "163"  # Pipeline step number
STEP_NAME = "external_dataset_registry"  # Used in log / output filenames
...
DATA_INT = PROJECT_ROOT / "data" / "interim"  # Processed catalogue products
