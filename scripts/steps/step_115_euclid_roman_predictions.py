...
STEP_NUM  = "115"  # Pipeline step number (sequential 001-176)
STEP_NAME = "euclid_roman_predictions"  # Euclid/Roman predictions: Fisher information approximation for expected rho(Gamma_t, dust) detection significance at 3σ with survey specifications
...
from scripts.utils.tep_model import (
    compute_gamma_t, stellar_to_halo_mass_behroozi_like, ALPHA_0, ALPHA_UNCERTAINTY  # Shared TEP model
)
