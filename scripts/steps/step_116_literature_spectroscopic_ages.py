...
from scripts.utils.tep_model import compute_gamma_t, stellar_to_halo_mass_behroozi_like  # TEP model: Gamma_t formula, stellar-to-halo mass from abundance matching

STEP_NUM = "116"  # Pipeline step number (sequential 001-176)
STEP_NAME = "spectroscopic_age_tension_prediction"  # Spectroscopic age tension: demonstrates t_true = t_apparent / Gamma_t for hypothetical massive galaxies at high redshift
