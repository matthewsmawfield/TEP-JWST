...
STEP_NUM = "046"  # Pipeline step number (sequential 001-176)
STEP_NAME = "multi_diagnostic"  # Multi-diagnostic search: explores 6 independent TEP diagnostics (UV slope, dust ratio, burstiness, chi² evolution, color excess, age divergence)
