...
from scripts.utils.tep_model import (
    compute_gamma_t, ALPHA_0, LOG_MH_REF, Z_REF,  # TEP model: Gamma_t formula, alpha_0=0.58, log_Mh_ref=12.0, z_ref=5.5
)
...
STEP_NUM = "113"  # Pipeline step number (sequential 001-176)
STEP_NAME = "agn_feedback_discriminant"  # AGN feedback discriminant: tests rho(dust, M_bh) < 0 (AGN) vs rho(dust, Gamma_t) > 0 (TEP) to break degeneracy via partial correlations
