...
Output:
- results/outputs/step_89_bbn_analysis.json
...
def compute_bbn_deviation():
    ...
    # Avoid division by zero if H_std is 0 (physically impossible here but good practice)
...
def main():
    ...
    output_file = output_dir / 'step_89_bbn_analysis.json'
