#!/usr/bin/env python3
"""
TEP-JWST Step 61: TEP Discriminant
...
def main():
    ...
    if tests_passed >= 4:
        print_status("✓ STRONG SUPPORT for TEP hypothesis", "INFO")
    elif tests_passed >= 3:
        print_status("✓ MODERATE SUPPORT for TEP hypothesis", "INFO")
