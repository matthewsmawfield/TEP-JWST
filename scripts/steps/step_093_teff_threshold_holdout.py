...
STEP_NUM = "093"  # Pipeline step number (sequential 001-176)
STEP_NAME = "teff_threshold_holdout"  # t_eff threshold holdout: leave-one-survey-out validation selecting t_eff threshold on training set, evaluating on held-out survey
