...
1. Monte Carlo null hypothesis testing
...
STEP_NUM = "105"
STEP_NAME = "evidence_strengthening"
...
def monte_carlo_null_test(x, y, n_simulations=10000):
    ...
    under the null hypothesis (no relationship)?
...
def alternative_hypothesis_test(df, x_col, y_col, z_col='z_phot'):
    """
    Test alternative hypotheses that could explain the correlation.
