#!/usr/bin/env python3
"""
Step 158: Scale-Dependent Growth Factor with Chameleon Yukawa Suppression
...
STEP_NUM = "158"
STEP_NAME = "scale_dependent_growth"
...
RHO_CRIT_SCREENING = 20.0  # g/cm³ — halo screening threshold
...
def run():
    ...
    print_status("Step 158: Scale-Dependent Growth with Chameleon Yukawa", "INFO")
    print_status("=" * 60, "INFO")
