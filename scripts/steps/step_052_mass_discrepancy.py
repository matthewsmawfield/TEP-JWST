...
STEP_NUM = "052"  # Pipeline step number (sequential 001-176)
STEP_NAME = "mass_discrepancy"  # Mass discrepancy: tests TEP prediction that M_star(SED)/M_dyn correlates with Gamma_t (unique signature)
