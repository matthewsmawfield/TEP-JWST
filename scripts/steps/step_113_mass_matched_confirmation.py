...
Outputs:
- results/outputs/step_113_mass_matched_confirmation.json
- results/figures/figure_113_mass_matched_confirmation.png
"""
...
def main():
    ...
    fig_path = FIGURES_PATH / 'figure_113_mass_matched_confirmation.png'
            ...
            if rho is not None and rho < 0:
                notes.append({
                    ...
                    'explanation': (
                        ...
                        'near-perfect mass-gamma_t collinearity in small sample. '
    ...
    out_json = OUTPUT_PATH / 'step_113_mass_matched_confirmation.json'
