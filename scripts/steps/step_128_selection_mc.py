...
def simulate_selection_effects(n_sim=5000, z_range=(8, 10), mass_range=(7.5, 11)):
    ...
    # Intrinsic dust: NO correlation with mass (null model)
...
def main():
    ...
    # Compile results
    results = {
        'step': f'Step {STEP_NUM}: Selection Effect Monte Carlo',
    ...
    # Save results
    output_path = OUTPUTS_DIR / f"step_{STEP_NUM}_selection_mc.json"
