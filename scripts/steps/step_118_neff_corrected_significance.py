...
STEP_NUM  = "118"  # Pipeline step number (sequential 001-176)
STEP_NAME = "neff_corrected_significance"  # N_eff-corrected significance: recomputes key p-values accounting for cosmic variance/clustering violations of statistical independence (N_eff ~ N / (1 + n_corr))
