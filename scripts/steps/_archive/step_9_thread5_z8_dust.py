...
def main():
    ...
    print()
    print("This is ANOMALOUS under standard timescales.")
    print()
    ...
    results = {
        ...
        "conclusion": "TEP prediction CONFIRMED - anomalous under standard timescales" if z8_result['significant'] else "Inconclusive",
    }
