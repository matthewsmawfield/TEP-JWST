...
correlation, which is anomalous under standard timescales.
...
def dust_timescale_sne():
    ...
    However, SN dust is often disrupted by reverse shocks.
...
def main():
    ...
    alternatives = [
        ("Supernova dust", 
         "SNe can produce dust in ~30 Myr, but reverse shocks disrupt most of it. "
