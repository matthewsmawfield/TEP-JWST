...
STEP_NUM = "084"  # Pipeline step number (sequential 001-176)
STEP_NAME = "effect_size_meta"  # Effect size meta-analysis: Fisher's z-transformed correlations, fixed/random-effects meta-analysis, heterogeneity assessment (I², Q, τ²), forest/funnel plots
