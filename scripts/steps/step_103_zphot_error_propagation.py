...
STEP_NUM  = "103"  # Pipeline step number (sequential 001-176)
STEP_NAME = "zphot_error_propagation"  # Photometric redshift error propagation: Monte Carlo (N=200) perturbation of z_phot by sigma=0.05*(1+z), testing Gamma_t correlation stability
...
N_SIMS = 200  # Number of Monte Carlo realisations for photo-z perturbation
