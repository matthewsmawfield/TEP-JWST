...
def load_citation_metadata():
    ...
    if not citation_file.exists():
        ...
        return {'version': 'v0.1', 'codename': 'Kos', 'title': 'TEP-JWST'}
...
def copy_pdf_to_docs(source_pdf: Path, docs_dir: Path):
    ...
    # Primary PDF name (12-TEP-JWST-vX.X-Codename.pdf)
    target_name = f"12-TEP-JWST-{version_str}.pdf"
